# Codex Skills Guide For packages/panel

Use this file when Codex CLI is working inside `packages/panel`. Do not load the entire `skills/` directory by default. Start with the smallest matching skill set.
